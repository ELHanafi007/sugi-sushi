...
const translations = {
  en: {
    ...
    'landing.flow_label': 'Order flow',
    'landing.flow_title': 'Built for quick decisions.',
    'landing.flow_copy': 'Move from craving to order without digging around. The landing page now behaves like a fast visual menu preview.',
    'landing.step1': 'Swipe the mood',
    'landing.step1_copy': 'Start with a category rail designed for thumbs, not desktop cursors.',
    'landing.step2': 'Spot the signature',
    'landing.step2_copy': 'Popular dishes surface early with image, price, and category context.',
    'landing.step3': 'Jump straight in',
    'landing.step3_copy': 'Tap any section or dish and the full menu opens exactly where the guest expects.',
  ...
  ar: {
    ...
    'landing.flow_label': 'طريقة الطلب',
    'landing.flow_title': 'مصممة لقرار سريع.',
    'landing.flow_copy': 'من الشهية إلى الطلب بدون لف كثير. الصفحة تعطي لمحة بصرية سريعة وتفتح القائمة على المكان المناسب.',
    'landing.step1': 'اسحب حسب المزاج',
    'landing.step1_copy': 'أقسام كبيرة وسهلة للمس، مناسبة للجوال والتابلت.',
    'landing.step2': 'شوف الاختيارات',
    'landing.step2_copy': 'الأطباق المميزة تظهر بدري مع الصورة والسعر والقسم.',
    'landing.step3': 'ادخل مباشرة',
    'landing.step3_copy': 'اضغط على أي قسم أو طبق وتفتح القائمة الكاملة في المكان المتوقع.',
