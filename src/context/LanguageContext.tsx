...
const translations = {
  en: {
    ...
    'loc.sun': 'Sunday',
    'loc.t1': '12:30 PM - 1:30 AM',
    'loc.t2': '12:30 PM - 1:30 AM',
    'loc.closed': 'Closed',
    ...
    'contact.hours': '12:30 PM - 1:30 AM',
    ...
    'landing.chefs_pick': "Chef's Pick",
  ...
  ar: {
    ...
    'loc.sun': 'الأحد',
    'loc.t1': '١٢:٣٠ م - ١:٣٠ ص',
    'loc.t2': '١٢:٣٠ م - ١:٣٠ ص',
    'loc.closed': 'مغلق',
    ...
    'contact.art_span': 'وجرّب',
    'contact.visit': 'زيارتنا',
    'contact.location': 'الرياض، المملكة العربية السعودية',
    'contact.visit_sub': 'الموقع',
    'contact.hours': '١٢:٣٠ م – ١:٣٠ ص',
    'contact.opening_sub': 'أوقات العمل',
    'contact.reservation_sub': 'للحجز',
    'contact.cta': 'احجز طاولتك',
    ...
    'footer.perfection': 'سوشي يُحضّر بعناية',
    ...
    'landing.location': 'سوشي طازج لمساءك',
    'landing.hero_title': 'شكل حلو، ومذاق أحلى.',
    'landing.hero_copy': 'رولات، ساشيمي، مقبلات ساخنة، مشروبات، وبوكسات للمشاركة — نكهات واضحة وتفاصيل مضبوطة.',
    'landing.view_menu': 'شوف القائمة',
    'landing.reserve': 'احجز',
    'landing.stat1': '+٢٠',
    'landing.stat1_label': 'قسم في القائمة',
    'landing.stat2': 'طازج',
    'landing.stat2_label': 'يُحضّر يومياً',
    'landing.stat3': 'عندنا',
    'landing.stat3_label': 'أو احجز طاولتك',
    'landing.categories_label': 'ابدأ من هنا',
    'landing.categories_title': 'اختار على مزاجك',
    'landing.all_menu': 'القائمة كاملة',
    'landing.open': 'ادخل',
    'landing.signatures_label': 'الأكثر طلباً',
    'landing.signatures_title': 'أطباق يرجعون لها كل مرة.',
    'landing.signatures_copy': 'لمحة على أسلوب سوجي: أرز مضبوط، صوصات متوازنة، وحشوات سخية.',
    'landing.chefs_pick': 'اختيار الشيف',
    'landing.craft_label': 'المطبخ',
    'landing.craft_title': 'تحضير نظيف. قطع طازجة. بدون تعقيد.',
    'landing.craft_copy': 'نركز على الأساسيات: مكونات زينة، لف دقيق، خدمة سريعة، ومذاق يبان من أول لقمة.',
    'landing.detail1': 'يتحضّر طازج',
    'landing.detail1_copy': 'الرولات والأطباق الساخنة تُجهّز قريب من وقت التقديم.',
    'landing.detail2': 'سهل للمشاركة',
    'landing.detail2_copy': 'بوكسات، قوارب، رولات، وأطباق جانبية — مناسبة للجلسة مع أصحابك أو عائلتك.',
    'landing.flow_label': 'طريقة الحجز',
    'landing.flow_title': 'حجز سهل وما ياخذ من وقتك.',
    'landing.flow_copy': 'من اختيار الموعد إلى تأكيد الطاولة — خطوات واضحة وتجربة مريحة.',
    'landing.step1': 'اختر وقتك',
    'landing.step1_copy': 'حدّد التاريخ والوقت اللي يناسبك.',
    'landing.step2': 'عطنا التفاصيل',
    'landing.step2_copy': 'كم عددكم؟ وإذا فيه طلبات خاصة، خبرنا علشان نجهّز لكم الطاولة.',
    'landing.step3': 'أكّد زيارتك',
    'landing.step3_copy': 'نستقبلكم في أجواء هادية، وليلة مرتبة على مزاجكم.',
    'landing.visit_label': 'جاهزين؟',
    'landing.visit_title': 'تعالوا جائعين... والباقي علينا.',
    'landing.visit_copy': 'تصفّح القائمة، احجز طاولتك، أو ادخل مباشرة على القسم اللي تحبه.',
