      ...
      <div className="container-luxury relative z-10 h-full flex flex-col justify-center">
        ...
        >
          ...
          <h1 className="text-display text-white mb-8">
            <span className="text-gold italic">FIND</span> US
          </h1>
          <p className="text-white/50 text-xl font-serif italic leading-relaxed">
            Located in the heart of Riyadh, a sanctuary of culinary precision awaits your arrival.
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          >
            <div>
              ...
              <h3 className="text-gold/40 text-[10px] uppercase tracking-[0.4em] font-mono font-bold mb-4">Location</h3>
              <p className="text-white/90 text-2xl font-serif font-light leading-tight mb-2">
                123 Luxury Avenue,<br />
                Olaya District
              </p>
              <p className="text-white/30 text-sm font-mono">Riyadh, Saudi Arabia</p>
            </div>
            ...
            <button className="text-left text-white/50 hover:text-gold text-[9px] uppercase font-mono tracking-widest mt-8 transition-colors flex items-center gap-2">
              Get Directions <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M5 12h14m-7-7 7 7-7 7"/></svg>
            </button>
          </motion.div>
          ...
          >
            <div>
              ...
              <h3 className="text-gold/40 text-[10px] uppercase tracking-[0.4em] font-mono font-bold mb-4">Hours</h3>
              <ul className="space-y-3">
                <li className="flex justify-between items-baseline border-b border-white/[0.04] pb-2">
                  <span className="text-white/70 font-serif text-lg">Mon - Thu</span>
                  <span className="text-gold/70 font-mono text-sm">1:00 PM - 12:00 AM</span>
                </li>
                <li className="flex justify-between items-baseline border-b border-white/[0.04] pb-2">
                  <span className="text-white/70 font-serif text-lg">Fri - Sat</span>
                  <span className="text-gold/70 font-mono text-sm">1:00 PM - 1:00 AM</span>
                </li>
                <li className="flex justify-between items-baseline pt-1">
                  <span className="text-white/70 font-serif text-lg">Sunday</span>
                  <span className="text-gold/70 font-mono text-sm">Closed</span>
                </li>
              </ul>
            </div>
          </motion.div>
          ...
          >
            <div>
              ...
              <h3 className="text-gold/40 text-[10px] uppercase tracking-[0.4em] font-mono font-bold mb-4">Reservations</h3>
              <p className="text-white/60 font-serif italic mb-6">
                For priority seating and private dining inquiries, please connect with our concierge.
              </p>
              <p className="text-white text-3xl font-serif font-light">+966 55 000 0000</p>
            </div>
            
            <a href="tel:+966550000000" className="cta-btn mt-8 px-6 py-4 rounded-xl text-[10px] uppercase tracking-widest font-mono text-white/80 hover:text-gold w-full">
              Call Concierge
            </a>
          </motion.div>
        </div>
